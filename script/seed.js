...
async function seed () {
  ...
  const products = await Promise.all([
    ...
    Product.create({title: 'Pool bbq', quantity: '51', description: 'For having bbqs in the pool!', price: '522', imgUrl: '/pics/bbqpool.jpg', categoryId: '1'}),
    Product.create({title: 'Cat butthole bling', quantity: '500', description: 'For jazzing up your cats romantic life', price: '10', imgUrl: '/pics/catbling.jpg', categoryId: '1'}),
    Product.create({title: 'Cover of original artwork', quantity: '50', description: 'Good artwork of shit', price: '100', imgUrl: '/pics/artwork.jpg', categoryId: '1'}),
    Product.create({title: 'Boomerang Gun', quantity: '50', description: 'Shoots boomerang', price: '10', imgUrl: '/pics/gun.jpg', categoryId: '1'})
  ])
