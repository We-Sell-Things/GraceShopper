...
async function seed () {
  ...
  const products = await Promise.all([
    ...
    Product.create({title: 'Computer usb lamp', description: 'For when you need extra brightness to your screen!', price: '2', imgUrl: 'http://lorempixel.com/400/200', categories: ['technology']}),
    Product.create({title: 'Beer warmer', description: 'For when your beer is too cold and it needs to be warmed!', price: '52', imgUrl: 'http://lorempixel.com/400/200', categories: ['technology']})
  ])
